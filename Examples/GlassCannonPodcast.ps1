...
$FeedFilters += New-Object FeedFilter("Echo Quest", "EchoQuest", "^Echo Quest.*", "Show description, not super improtant, but why not include it?","https://glasscannonnetwork.com/wp-content/uploads/2019/10/EchoQuest-1-1.jpg","[optional] https://url.toThe.Forums")
$FeedFilters += New-Object FeedFilter("Disorganized Play", "DisorganizedPlay", "^Disorganized Play.*", "Show description, not super improtant, but why not include it?","https://i.imgur.com/qVoCwAW.png","[optional] https://url.toThe.Forums")
